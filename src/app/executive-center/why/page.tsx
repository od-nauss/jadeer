      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {[
            ...
            { icon: '⚖️', title: 'قناة رسمية تُبرز أصحاب الإمكانات', body: 'إتاحة مسار موضوعي وموثوق لكل موظف مؤهل يُعزز ثقته بمنظمته ويُطلق طاقته الكامنة، مما يرفع الولاء المؤسسي ويُقوّي الانتماء.' },
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                ...
                'قرار التكليف يستحق سنداً تحليلياً أقوى وأكثر شمولاً',
              ].map((item, i) => (
