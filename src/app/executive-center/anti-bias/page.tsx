...
const GUARANTEES = [
  { title: 'اعتماد المقيّمين بيد لجنة الحوكمة', body: 'الموظف يقترح 15 اسماً فقط — واللجنة هي التي تعتمد 7–10 مقيّمين وتُحدد 60٪ منهم على الأقل، مما يضمن تنوع المصادر وحياديتها.', icon: Shield },
...
const CYCLE = [
  { label: 'الموظف يقترح', sub: '15 اسماً' },
  { label: 'اللجنة تعتمد', sub: '7–10 مقيّمين' },
    ...
    <div className="space-y-16 max-w-5xl mx-auto" dir="rtl">
      ...
      <section>
        <div className="text-center mb-10">
          <h2 className="text-2xl font-bold text-white mb-2">6 ضمانات تحمي سلامة العملية</h2>
