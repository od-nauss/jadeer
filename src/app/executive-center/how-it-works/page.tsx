...
const PHASES = [
  ...
  {
    phase: 'رابعاً',
    title: 'المخرجات — نظام البطاقات الثلاث',
    color: 'bg-sage',
    steps: [
      { n: '12', label: 'بطاقة الجاهزية القيادية', sub: 'درجة الجاهزية · السلوك · التأثير · تقييم 360' },
      { n: '13', label: 'بطاقة الأداء المتوازن', sub: 'الأثر المؤسسي · المبادرات · الإنجاز · الأهداف' },
      { n: '14', label: 'بطاقة التوصية النهائية', sub: 'قراءة مركبة → مسار التطوير أو التمكين' },
      { n: '15', label: 'لوحة الرئيس والتعاقب', sub: 'خريطة الملاءمة التنظيمية · خطة التطوير الفردية' },
    ],
  },
];
