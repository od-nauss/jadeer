...
const BENEFICIARIES = [
  ...
  },
  {
    ...
    benefits: [
      { title: 'قناة رسمية موثوقة', desc: 'مسار واضح لكل موظف مؤهل يرغب في إثبات جاهزيته — وفق معايير موضوعية موثقة تُعطي كل كفاءة حقها.' },
  ...
  },
  {
    ...
    message: 'المنظمة التي تستثمر في كفاءاتها بمنهجية اليوم — تقود قطاعها غداً.',
  },
];
