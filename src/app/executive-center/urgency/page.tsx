...
const URGENCY_POINTS = [
  ...
  {
    icon: Brain,
    title: 'الكفاءات المخفية لا تظهر في الاجتماعات',
    desc: 'من يقود التغيير الحقيقي في المنظمة لا يُرى دائماً في الصف الأمامي. جدير تجعله مرئياً بالأدلة.',
  },
  {
    icon: Users,
    title: 'الموظف المتميز يستحق قناة واضحة لإثبات نفسه',
    desc: 'توفير مسار رسمي وموضوعي لكل موظف مؤهل يُعزز ثقته بمنظمته ويُطلق طاقته الكامنة — مما يرفع الانتماء والولاء المؤسسي.',
  },
  {
    icon: ShieldCheck,
      ...
      <section className="bg-gradient-to-br from-primary-700/40 to-primary-900/40 border border-primary-400/20 rounded-3xl p-8 md:p-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="space-y-3">
            ...
            {[
              'رؤية محدودة بما يصل إلى الطاولة فقط',
              'صعوبة الوصول إلى الكفاءات غير المرئية إدارياً',
              'بيانات متفرقة وغير مترابطة',
              'غياب تقييم متعدد المصادر',
              'قرارات التكليف تحتاج توثيقاً أعمق لدعمها',
              'فراغ مؤسسي مفاجئ بلا بدائل جاهزة',
            ].map((item, i) => (
          ...
          <div className="space-y-3">
            ...
            {[
              ...
              'تحليل ذكي يكشف الكفاءات المخفية',
