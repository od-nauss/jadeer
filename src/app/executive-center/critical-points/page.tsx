...
const CRITICAL_POINTS = [
  {
    ...
    risk: 'دون هذه الآلية: يصعب ضمان التنوع الكافي والموضوعية في مصادر التقييم.',
  ...
  },
  {
    ...
    risk: 'دون هذا: يصعب التحقق الكافي من أن التقييم تم من قِبل الشخص المعتمد فعلاً.',
  ...
  },
  {
    ...
    why: 'التحيزات الإنسانية — الإيجابية والسلبية — واردة في أي بيئة. المنصة ترصد أثرها قبل أن يؤثر على النتيجة.',
    risk: 'دون هذا: تقييم متطرف واحد — إيجاباً أو سلباً — قد يؤثر على مصداقية النتيجة الكلية.',
  ...
  },
  {
    ...
    bg: 'bg-purple-400/10',
    title: 'كشف الكفاءات غير المرئية',
    what: 'تحليل الأنماط عبر المبادرات وتقييم الزملاء والأثر الفعلي — لا المنصب الرسمي.',
    why: 'كثير من الكفاءات الاستثنائية لا تصل إلى دائرة الضوء بسبب محدودية الحضور الإداري لا محدودية القدرة.',
    risk: 'دون هذا: كفاءات استثنائية قد تبقى غير مرئية رغم إمكاناتها الكبيرة.',
    solution: 'علامة "كفاءة استثنائية غير مرئية" تُرفع للقيادة مع ملخص الأدلة الداعمة.',
  },
  {
    icon: FileSearch,
    color: 'text-sage',
    ...
    risk: 'دون هذا: يصعب التحقق المستقل من الإنجازات وتقدير الأثر الفعلي للمرشح.',
