...
const MODELS = [
  {
    ...
    insight: 'نمط متسق عبر 3 سنوات — أعلى 8٪ من المتقدمين',
    ...
    recommendation: 'تكليف قيادي مباشر موصى به. الوحدة الأنسب: إدارة العمليات (ملاءمة 92٪). برنامج مصاحب في التخطيط الاستراتيجي مدة 6 أشهر.',
  ...
  },
  {
    ...
    trustScore: 85,
    type: 'قائد استراتيجي',
    classification: 'جاهز خلال 12 شهراً',
    ...
    recommendation: 'برنامج إعداد قيادي 8 أشهر + تكليف بمشروع تنفيذي استراتيجي + إعادة تقييم بعد 12 شهراً.',
  ...
  },
  {
    ...
    recommendation: 'تدريب في بناء مؤشرات الأداء + تكليف بإعداد لوحة مؤشرات فريق + متابعة الأثر بعد 3 أشهر.',
  ...
  },
  {
    ...
    recommendation: 'برنامج التواصل القيادي + إدارة أصحاب العلاقة + تكليف بقيادة فريق صغير + إعادة تقييم بعد 6 أشهر.',
  ...
  },
  {
    ...
    recommendation: 'تدريب في القيادة الإنسانية + إرشاد في إدارة الخلافات + قياس رضا الفريق بعد 6 أشهر + إعادة تقييم قبل أي تكليف مباشر.',
