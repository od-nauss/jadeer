...
const APPROVALS = [
  ...
  { title: 'اعتماد تقييم 360° عبر دائرة الثقة القيادية', desc: 'منهجية مُحكمة: 15 مقترحاً — 7-10 معتمدين — 60٪ تختارهم اللجنة.' },
    ...
    <div className="space-y-14 max-w-5xl mx-auto" dir="rtl">
      ...
      <div className="text-center py-6">
        ...
        <p className="text-lg text-white/65 max-w-2xl mx-auto">
          ما تبنيه القيادة اليوم في مجال اكتشاف الكفاءات وتأهيلها
          هو أحد أعمق الإرثات المؤسسية التي تبقى عبر الزمن.
        </p>
      </div>
      ...
      <div className="bg-gradient-to-br from-primary-700 to-primary-900 border-2 border-gold-400/40 rounded-2xl p-10 text-center">
        <div className="flex justify-center gap-1 mb-6">
          {[1,2,3].map(i => <Star key={i} className="h-5 w-5 text-gold-400" style={{fill:'#C7B08C'}} />)}
        </div>
