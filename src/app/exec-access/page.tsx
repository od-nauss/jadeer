...
export default function ExecAccessPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-800 via-primary-900 to-primary-700 flex items-center justify-center px-4 py-8 relative overflow-hidden" dir="rtl">
      ...
      <div className="relative max-w-md w-full">
        ...
        <Link href="/" className="mt-6 flex items-center justify-center gap-2 text-sm text-white/70 hover:text-gold-300 transition">
