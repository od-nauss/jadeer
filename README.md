...
|------|-------|---------|--------|
| نورة عبدالله | 87% | جاهز الآن | `noura@nauss.edu.sa` |
| فهد خالد | 81% | إنجاز عالٍ / رضا منخفض | `fahad@nauss.edu.sa` |
| سعد محمد | 78% | جاهز خلال سنة | `saad@nauss.edu.sa` |
| هند عمر | 76% | قائد إنساني | `hind@nauss.edu.sa` |
| عبدالعزيز سالم | 71% | واعد | `abdulaziz@nauss.edu.sa` |
